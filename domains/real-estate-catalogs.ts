...
// Plan Task 1 Step 2 Field 1 — scene (select).
...
// Plan Task 1 Step 2 Field 2 — gaya desain (select).
...
// Plan Task 1 Step 2 Field 3 — waktu/cahaya (select).
...
// Plan Task 1 Step 2 Field 4 — staging (select).
...
// Plan Task 1 Step 2 Field 5 — angle & lens (select).
