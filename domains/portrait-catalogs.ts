...
export const PORTRAIT_LENSES: LensOption[] = [
  { value: '85mm-closeup', label: '85mm close-up', image: '/images/focal-length/85mm-portrait.webp', promptPhrase: 'an 85mm lens, head-and-shoulders framing' },
  { value: '50mm-half', label: '50mm half-body', image: '/images/focal-length/50mm-standard.webp', promptPhrase: 'a 50mm lens, half-body framing' },
  { value: '35mm-environmental', label: '35mm environmental', image: '/images/focal-length/35mm-wide.webp', promptPhrase: 'a 35mm lens, environmental framing with context around the subject' },
...
export const PORTRAIT_PHOTOGRAPHERS: PhotographerOption[] = [
  ...
  { value: 'annie-leibovitz', label: 'Annie Leibovitz', image: '/images/photographers/annie-leibovitz.webp', promptPhrase: 'in the style of Annie Leibovitz, dramatic painterly lighting, conceptual editorial portrait' },
  { value: 'peter-lindbergh', label: 'Peter Lindbergh', image: '/images/photographers/peter-lindbergh.webp', promptPhrase: 'in the style of Peter Lindbergh, raw black-and-white realism, natural unretouched beauty' },
  { value: 'platon', label: 'Platon', image: '/images/photographers/platon.webp', promptPhrase: 'in the style of Platon, tight framing, intense direct gaze, powerful simplicity' },
  { value: 'richard-avedon', label: 'Richard Avedon', image: '/images/photographers/richard-avedon.webp', promptPhrase: 'in the style of Richard Avedon, stark white background, psychological intensity, sharp detail' },
  { value: 'steve-mccurry', label: 'Steve McCurry', image: '/images/photographers/steve-mccurry.webp', promptPhrase: 'in the style of Steve McCurry, vivid color, soulful environmental storytelling' },
  { value: 'rankin', label: 'Rankin', image: '/images/photographers/rankin.webp', promptPhrase: 'in the style of Rankin, bold glossy fashion lighting, high-contrast beauty' },
];
